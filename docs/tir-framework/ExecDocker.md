...
1. Baixe os exemplos dos arquivos que serão necessários para a execução na pasta [basic template](https://github.com/totvs/tir-script-samples/tree/master/basic_template).
2. No PowerShell, acesse a pasta onde descompactou os arquivos.
3. Execute o comando:
